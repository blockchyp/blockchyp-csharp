...
{
    public class TerminalKeyedChargeTest : IntegrationTest
    {
        private readonly ITestOutputHelper output;

        public TerminalKeyedChargeTest(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        [Fact]
        public async void Run_TerminalKeyedChargeTest()
        {


            UseProfile("");
            ShowTestOnTerminal("TerminalKeyedCharge");
                                                                                                                                            ...
                                                                                                                                            Assert.NotEmpty(response.TransactionId);
                                                                                                                                                            ...
                                                                                                                                                            Assert.NotEmpty(response.PaymentType);
                                                                                                                                                                            ...
                                                                                                                                                                            Assert.NotEmpty(response.EntryMethod);
                                                                                                                                                                                            Assert.Equal("11.11", response.AuthorizedAmount);
                                                            }
            catch (Exception e) {
                err = e;
            }
