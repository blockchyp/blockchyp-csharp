...
{
    public class DeleteSurveyQuestionTest : IntegrationTest
    {
        private readonly ITestOutputHelper output;

        public DeleteSurveyQuestionTest(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        [Fact]
        public async void Run_DeleteSurveyQuestionTest()
        {
