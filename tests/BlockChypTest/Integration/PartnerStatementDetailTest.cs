...
{
    public class PartnerStatementDetailTest : IntegrationTest
    {
        private readonly ITestOutputHelper output;

        public PartnerStatementDetailTest(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        [Fact]
        public async void Run_PartnerStatementDetailTest()
        {
