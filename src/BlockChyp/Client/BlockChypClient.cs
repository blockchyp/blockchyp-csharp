...
namespace BlockChyp.Client
{
    ...
    public class BlockChypClient
    {
        ...
        {
            return await GatewayRequestAsync<MerchantProfileResponse>(HttpMethod.Post, "/api/merchant-profile", request, null, request.Test)
                .ConfigureAwait(false);
        }
        ...
        {
            return GatewayRequest<MerchantProfileResponse>(HttpMethod.Post, "/api/merchant-profile", request, null, request.Test);
        }
